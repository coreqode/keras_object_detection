...
if __name__ == "__main__":
    ...
    args.add_argument('--num_data', type=int, default=306452)
    ...
    args.add_argument('--trainset_path', type=str, default="/home/chan/data/trainset_300k.record")
    args.add_argument('--valset_path', type=str, default="/home/chan/data/valset_300k.record")
    ...
    with strategy.scope():
        ...
        model.fit(x=train_gen[0], y = train_gen[1], epochs = config.epochs, 
                                        steps_per_epoch = STEP_SIZE_TRAIN,
                                        validation_data = val_gen,
                                        validation_steps = STEP_SIZE_VAL,
                                        # callbacks = [early_stopping, checkpoint],
